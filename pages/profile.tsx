...
const Profile = () => {
  ...
  return (
    <div className="bg-gray min-h-screen">
      ...
      <main className="flex container justify-center items-center mx-auto px-8 py-12">
        <div className="bg-white my-10 p-10 rounded shadow border-[#8ab13c] border  max-w-5xl w-full">
