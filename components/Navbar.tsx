...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden absolute left-0 top-16 w-full z-10 bg-gray-600 shadow border-gray-300 border p-10 space-y-4 ${menuOpen ? "opacity-100" : "opacity-0 pointer-events-none"
