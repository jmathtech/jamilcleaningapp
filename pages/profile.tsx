...
const Profile = () => {
  ...
  return (
    <div className="bg-gray min-h-screen">
      ...
      <main className="flex justify-center items-center min-h-screen text-md mx-auto px-4 py-6">
        <div className="bg-white p-8 rounded shadow border-[#8ab13c] border my-6 w-full-3xl">
